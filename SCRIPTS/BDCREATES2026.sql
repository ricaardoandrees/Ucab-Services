...
CREATE TABLE Egresado (
    ...
    CONSTRAINT FK_EGRESADO_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE Estudiante (
    ...
    CONSTRAINT FK_ESTUDIANTE_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE Becario (
    ...
    CONSTRAINT FK_BECARIO_ESTUDIANTE FOREIGN KEY (CI) REFERENCES Estudiante(CI)
);
...
CREATE TABLE Preparador (
    ...
    CONSTRAINT FK_PREPARADOR_ESTUDIANTE FOREIGN KEY (CI) REFERENCES Estudiante(CI)
);
...
CREATE TABLE Profesor (
    ...
    CONSTRAINT FK_PROFESOR_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE PersonalAdministrativo (
    ...
    CONSTRAINT FK_PERSONALADMINISTRATIVO_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE Sesion (
    ...
    CONSTRAINT FK_SESION_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE PeriodoVinculacion (
    ...
    CONSTRAINT FK_PERIODOVINCULACION_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE Vehiculo (
    ...
    CONSTRAINT FK_VEHICULO_MIEMBRO FOREIGN KEY (CI) REFERENCES Miembro(CI)
);
...
CREATE TABLE Beneficiario (
    ...
    CONSTRAINT FK_BENEFICIARIO_MIEMBRO FOREIGN KEY (CI_miembro) REFERENCES Miembro(CI)
);
...
CREATE TABLE CargaMenor (
    ...
    CONSTRAINT FK_CARGAMENOR_BENEFICIARIO FOREIGN KEY (CI) REFERENCES Beneficiario(CI)
);
...
CREATE TABLE CargaMayor (
    ...
    CONSTRAINT FK_CARGAMAYOR_BENEFICIARIO FOREIGN KEY (CI) REFERENCES Beneficiario(CI)
);
...
CREATE TABLE EntidadInterna (
    ...
    CONSTRAINT FK_ENTIDADINTERNA_ENTIDADPRESTADORA FOREIGN KEY (ID_EP) REFERENCES EntidadPrestadora(ID_EP)
);
...
CREATE TABLE EntidadExterna (
    ...
    CONSTRAINT FK_ENTIDADEXTERNA_ENTIDADPRESTADORA FOREIGN KEY (ID_EP) REFERENCES EntidadPrestadora(ID_EP)
);
...
CREATE TABLE Contactos (
    ...
    CONSTRAINT FK_CONTACTOS_ENTIDADEXTERNA FOREIGN KEY (RIF) REFERENCES EntidadExterna(RIF)
);
...
CREATE TABLE OfertaLaboral (
    ...
    CONSTRAINT FK_OFERTALABORAL_ENTIDADEXTERNA FOREIGN KEY (RIF) REFERENCES EntidadExterna(RIF)
);
...
CREATE TABLE Suplemento (
    ...
    CONSTRAINT FK_SUPLEMENTO_SERVICIO FOREIGN KEY (nombre, numero_servicio) REFERENCES Servicio(nombre, numero_servicio)
);
...
CREATE TABLE Historial_Tarifas (
    ...
    CONSTRAINT PK_HISTORIAL_TARIFAS PRIMARY KEY (fecha_hora_vigencia, nombre_servicio, numero_servicio),
    CONSTRAINT FK_HISTORIAL_SERVICIO FOREIGN KEY (nombre_servicio, numero_servicio) REFERENCES Servicio(nombre, numero_servicio)
);
...
CREATE TABLE Acompanante (
    ...
    CONSTRAINT FK_ACOMPANANTE_SOLICITUD FOREIGN KEY (fecha_hora_creacion) REFERENCES Solicitud(fecha_hora_creacion)
);
...
CREATE TABLE Paso_Actividad (
    ...
    CONSTRAINT FK_PASO_SOLICITUD FOREIGN KEY (fecha_hora_creacion_solicitud) REFERENCES Solicitud(fecha_hora_creacion),
...
CREATE TABLE Edificacion (
    ...
    CONSTRAINT FK_EDIFICACION_SEDE FOREIGN KEY (nombre_sede) REFERENCES Sede(nombre)
);
...
CREATE TABLE EspacioFisico (
    ...
    CONSTRAINT FK_ESPACIO_EDIFICACION FOREIGN KEY (nombre_edif, direccion_exacta, nombre_sede) REFERENCES Edificacion(nombre, direccion_exacta, nombre_sede)
);
...
CREATE TABLE Recursos (
    ...
    CONSTRAINT FK_RECURSOS_ESPACIOFISICO FOREIGN KEY (numero, nombre_espacio_fisico, direccion_exacta, nombre_sede) REFERENCES EspacioFisico(numero, nombre_edif, direccion_exacta, nombre_sede)
);
...
CREATE TABLE Ajusta (
    ...
    minimo_limite NUMERIC(10,2) NOT NULL,
...
CREATE TABLE Estacionamiento (
    ...
    CONSTRAINT FK_ESTACIONAMIENTO_SEDE FOREIGN KEY (nombre_sede) REFERENCES Sede(nombre)
);
...
CREATE TABLE Puesto_Estacionamiento (
    ...
    CONSTRAINT FK_PUESTO_ESTACIONAMIENTO FOREIGN KEY (nombre_estacionamiento, nombre_sede) REFERENCES Estacionamiento(nombre, nombre_sede)
);
...
CREATE TABLE Folio_Consumo (
    ...
    CONSTRAINT FK_FOLIO_SOLICITUD FOREIGN KEY (fecha_hora_creacion_solicitud) REFERENCES Solicitud(fecha_hora_creacion)
);
...
CREATE TABLE Item_Consumo (
    ...
    CONSTRAINT FK_ITEM_FOLIO FOREIGN KEY (fecha_hora_apertura, fecha_hora_creacion_solicitud) REFERENCES Folio_Consumo(fecha_hora_apertura, fecha_hora_creacion_solicitud),
    CONSTRAINT FK_ITEM_HISTORIAL FOREIGN KEY (fecha_hora_vigencia, nombre_servicio, numero_servicio) REFERENCES Historial_Tarifas(fecha_hora_vigencia, nombre_servicio, numero_servicio)
);
...
CREATE TABLE Pago_Presencial (
    ...
    CONSTRAINT FK_PRESENCIAL_PAGOS FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pagos(fecha_hora_pago, monto)
);
...
CREATE TABLE Pago_Digital (
    ...
    CONSTRAINT FK_DIGITAL_PAGOS FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pagos(fecha_hora_pago, monto)
);
...
CREATE TABLE Zelle (
    ...
    CONSTRAINT FK_ZELLE_DIGITAL FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pago_Digital(fecha_hora_pago, monto)
);
...
CREATE TABLE Crypto (
    ...
    CONSTRAINT FK_CRYPTO_DIGITAL FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pago_Digital(fecha_hora_pago, monto)
);
...
CREATE TABLE Tarjeta (
    ...
    CONSTRAINT FK_TARJETA_PRESENCIAL FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pago_Presencial(fecha_hora_pago, monto)
);
...
CREATE TABLE PagoMovil (
    ...
    CONSTRAINT FK_PAGOMOVIL_PRESENCIAL FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pago_Presencial(fecha_hora_pago, monto)
);
...
CREATE TABLE TAI (
    ...
    CONSTRAINT FK_TAI_PRESENCIAL FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pago_Presencial(fecha_hora_pago, monto)
);
...
CREATE TABLE Efectivo (
    ...
    CONSTRAINT FK_EFECTIVO_PRESENCIAL FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Pago_Presencial(fecha_hora_pago, monto)
);
...
CREATE TABLE Denominaciones (
    ...
    CONSTRAINT FK_DENOMINACIONES_EFECTIVO FOREIGN KEY (fecha_hora_pago, monto) REFERENCES Efectivo(fecha_hora_pago, monto)
);